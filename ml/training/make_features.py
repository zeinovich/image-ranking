...
def cli():
    parser = argparse.ArgumentParser(description="Make embeddings for the images in the dataset.")
    parser.add_argument("--input_file", type=str, default="data", help="Path to the input file.")
    parser.add_argument("--output_file", type=str, default="data", help="Path to the output file.")
    parser.add_argument("--view", type=str, default="default", help="View of the image to use.")
